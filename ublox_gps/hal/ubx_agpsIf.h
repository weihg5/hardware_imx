 ...
 *
 ******************************************************************************
 * $Id: ubx_agpsIf.h 83032 2014-07-14 16:14:58Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_v3.10/gps/hal/ubx_agpsIf.h $
 *****************************************************************************/
...
public:
    ...
    int getConnectRetries(void) const { return m_connectRetries; };
    void setConnectRetries(int connectRetries) { m_connectRetries = connectRetries; };
#endif
