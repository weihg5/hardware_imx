 ...
 *
 ******************************************************************************
 * $Id: ubx_tcpServer.cpp 96363 2015-05-27 18:38:02Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_v3.10/gps/hal/ubx_tcpServer.cpp $
 *****************************************************************************/
/*!
  \file
...
int CTcpServer::impl_open(int **fds, int *timeout_ms)
{
    ...
    si_me.sin_port = (unsigned short) htons((unsigned short) _port);
    si_me.sin_addr.s_addr = htonl(_localhostOnly?INADDR_LOOPBACK:INADDR_ANY);
...
*/
void CTcpServer::impl_errorOccurred(int operation, int fdindex, int correrrno)
{
	switch(operation)
	{
