 ...
 *
 ******************************************************************************
 * $Id: database.cpp 86496 2014-10-24 17:37:48Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/PRODUCTS/libParser/tags/libParser_v1.03/database.cpp $
 *****************************************************************************/
/*!
  \file
...
int CDatabase::ConvertUbxPrn2NmeaSvid(int svid)
{
	if ((svid >= 1) && (svid <= 32))
	{
	...
	{
		// NMEA has not reserved SVs for GALILEO, QZSS, IMS or BEIDOU (until Nmea 4.1 support is added)
		svid = 0;
	}
	return svid;
}
