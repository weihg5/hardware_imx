 ...
 *
 ******************************************************************************
 * $Id: AssistNowMga.h 95458 2015-05-07 13:01:29Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_v3.10/gps/agnss/AssistNowMga.h $
 *****************************************************************************/
...
private:
	...
	static const struct UBX_MSG_TYPE
	                    _online_allowed[];      //!< Valid LEG Online UBX msgs
	static const struct UBX_MSG_TYPE
	                    _offline_allowed[];     //!< Valid LEG Offline UBX msgs
	static const struct UBX_MSG_TYPE            //!< Valid LEG Receiver state messages
	                    _recv_state_allowed[];
};
