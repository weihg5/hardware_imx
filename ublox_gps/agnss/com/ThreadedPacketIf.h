 ...
 *
 ******************************************************************************
 * $Id: ThreadedPacketIf.h 96288 2015-05-26 16:56:02Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_v3.10/gps/agnss/com/ThreadedPacketIf.h $
 *****************************************************************************/
...
protected: // Functions
	...
	//! Will report an error to the derived class that occured in \ref CComThread
	void errorOccurred(int operation, int fdindex, int correrrno);
	...
	*/
	virtual void impl_errorOccurred(int operation, int fdindex, int correrrno)=0;
