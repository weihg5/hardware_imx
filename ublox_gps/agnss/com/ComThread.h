 ...
 *
 ******************************************************************************
 * $Id: ComThread.h 96287 2015-05-26 16:54:58Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_v3.10/gps/agnss/com/ComThread.h $
 *****************************************************************************/
...
public: // Definitions
	...
	*/
	...
	/*! Pointer to a function that has to be notified of a \ref CComThread error
	    ...
	    \param fdindex             : Number of the file description on which
...
private: // Functions
	...
	//! Handle the delayed closes from \ref close_delayed
