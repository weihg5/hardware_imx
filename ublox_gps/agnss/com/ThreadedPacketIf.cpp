 ...
 *
 ******************************************************************************
 * $Id: ThreadedPacketIf.cpp 96288 2015-05-26 16:56:02Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_v3.10/gps/agnss/com/ThreadedPacketIf.cpp $
 *****************************************************************************/
...
*/
void CThreadedPacketIf::errorOccurred(int operation, int fdindex, int correrrno)
{
