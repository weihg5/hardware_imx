 ...
 *
 ******************************************************************************
 * $Id: Agnss.cpp 96289 2015-05-26 16:56:36Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_v3.10/gps/agnss/Agnss.cpp $
 *****************************************************************************/
...
*/
void CAgnss::impl_errorOccurred(int operation, int fdindex, int correrrno)
{
	switch(operation)
	{
