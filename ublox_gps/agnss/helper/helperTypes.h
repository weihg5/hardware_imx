 ...
 *
 ******************************************************************************
 * $Id: helperTypes.h 94055 2015-04-13 16:54:32Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_v3.10/gps/agnss/helper/helperTypes.h $
 *****************************************************************************/
...
#define LEAP_SECONDS_UNIX 26                  //!< Leap seconds between Unix Epoch 1970.01.01T00:00:00  and 2012.10.22T00:00:00
#define LEAP_SECONDS_GPS LEAP_SECONDS_UNIX-10 //!< GPS leap second since 1980.1.6T00:00:00
...
#define GPS_EPOCH_UNIX_S 315964800LL          //!< GPS Epoch in seconds since the Unix Epoch (this is mkgmtime(1980,1,6,0,0,0,0))
#define EARLIEST_TIME_S  1420070400LL         //!< Earliest possible time this software might be existing at 2015-01-01T00:00:00+00:00
