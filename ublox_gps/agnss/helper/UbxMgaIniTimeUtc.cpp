 ...
 *
 ******************************************************************************
 * $Id: UbxMgaIniTimeUtc.cpp 94303 2015-04-15 20:22:17Z fabio.robbiani $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_v3.10/gps/agnss/helper/UbxMgaIniTimeUtc.cpp $
 *****************************************************************************/
...
bool CUbxMgaIniTimeUtc::writeUbxMgaIniTimeUtc(ACCTIME_t const * accTime)
{
	...
	if(createMgaIniTimeUtc(&data, accTime))
	{
		...
		if(bufSize>=0)
		{
			...
			result=(writeData(buf, (size_t) bufSize)>0);
			free(buf);	
		}
	}
